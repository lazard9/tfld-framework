...
// /* Checks theme root folder */
// $new_template = locate_template( 'archive-courses.php' );
// var_dump($new_template);
// /* If the plugin adds the same template, we need the exact location in the theme folder structure. */
// $new_template2 = locate_template( 'templates/archive/archive-courses.php' );
// var_dump($new_template2);